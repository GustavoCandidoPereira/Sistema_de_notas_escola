...
public class Atividade_escola_intgrafica extends JPanel {
	...
	public void inicializarComponentes() {
		...
		img1 = new ImageIcon("C:\\Users\\Gustavo\\Desktop\\logo.png");
		lbimg = new JLabel(img1);
		img2 = new ImageIcon("C:\\Users\\Gustavo\\Desktop\\happy.png");
		lbimg2 = new JLabel(img2);
		img3 = new ImageIcon("C:\\Users\\Gustavo\\Desktop\\sad.png");
		...
		btcalcular.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (resu > 6) {
					...
					lbimg3.setVisible(false);
					lbcalcular.setText("O aluno " + tfnome.getText() + " (" + tfnumero.getText() + ")" + ", da turma " + tfturma.getText() + ", com a média de: " + formatador.format(resu) + " está aprovado.");
				}
				if (resu > 4 && resu < 6) {
					lbimg3.setVisible(true);
					lbimg2.setVisible(false);
					lbcalcular.setText("O aluno " + tfnome.getText() + " (" + tfnumero.getText() + ")" + ", da turma " + tfturma.getText() + ", com a média de: " + formatador.format(resu) + " está de recuperação.");
					}
				if (resu < 4) {
					lbimg3.setVisible(true);
					lbimg2.setVisible(false);
					lbcalcular.setText("O aluno " + tfnome.getText() + " (" + tfnumero.getText() + ")" + ", da turma " + tfturma.getText() + ", com a média de: " + formatador.format(resu) + " está reprovado.");
					}
				}		
	});
